...
function() {
    ...
    function(a, b, c) {
        var d, e;
        d = [c(44), c(45), c(86), c(84), c(80), c(98)],
    ...
    function(a, b, c) {
        var d, e;
        d = [c(46), c(62), c(47), c(48), c(61), c(60), c(45), c(63), c(165), c(166), c(167), c(59)],
        e = function(a, b, c, d, e, f, g, h, i, j, k, l) {
            var m = function(f, m) {
                ...
                this.trigger = function(a, b) {
                    ...
                    b) : {},
                    b.type = a,
                    window.jwplayer && window.jwplayer.debug ? c.trigger.call(o, a, b) : c.triggerSafe.call(o, a, b)
                },
                ...
                var r = function() {
                    ...
                    i(o, n),
                    j(o, n),
                    n.on(a.JWPLAYER_PLAYLIST_ITEM,
                    function() {
                        q = {}
                    }),
                    n.on(a.JWPLAYER_MEDIA_META,
                    function(a) {
                        g.extend(q, a.metadata)
                    }),
                    n.on(a.JWPLAYER_READY,
                    function(a) {
                        p = !0,
                        s.tick("ready"),
                        a.setupTime = s.between("setup", "ready")
                    }),
                    n.on("all", o.trigger)
                };
                r(),
                ...
                var t = function() {
                    ...
                    o.off(),
                    n && n.off(),
                    n && n.playerDestroy && n.playerDestroy()
                };
    ...
    function(a, b, c) {
        var d, e;
        d = [c(51), c(45), c(52), c(53), c(55), c(49), c(56), c(50), c(57), c(60)],
    ...
    function(a, b, c) {
        ...
        e = function(a, b, d) {
            ...
            return a.prototype.setup = function(a, f) {
                ...
                j = this;
                h("casting") && i && i.appid && c.e(6,
                function(a) {
                    var b = c(159);
                    j._castController = new b(j, j._model),
                    j.castToggle = j._castController.castToggle.bind(j._castController)
                });
                var k = d.setup();
                this.once("ready", k.onReady, this),
                f.getAdBlock = k.checkAdBlock
            },
            a
        }.apply(b, d),
        !(void 0 !== e && (a.exports = e))
    ...
    function(a, b, c) {
        var d, e;
        d = [c(73), c(115), c(74), c(45), c(93), c(111), c(77), c(114), c(65), c(48), c(116), c(47), c(76), c(62), c(46), c(156)],
            ...
            return s.prototype = {
                ...
                setup: function(g, l) {
                    ...
                    function q() {
                        X = null,
                        D(U.get("item")),
                        U.on("change:state", m, this),
                        U.on("change:castState",
                        function(a, b) {
                            aa.trigger(o.JWPLAYER_CAST_SESSION, b)
                        }),
                        U.on("change:fullscreen",
                        function(a, b) {
                        ...
                        U.on("change:controls",
                        function(a, b) {
                            aa.trigger(o.JWPLAYER_CONTROLS, {
                                controls: b
                            })
                        }),
                        U.on("change:scrubbing",
                        function(a, b) {
                            b ? y() : w()
                        }),
                        U.on("change:captionsList",
                        function(a, b) {
                        ...
                        U.mediaController.on("all", aa.trigger.bind(aa)),
                        V.on("all", aa.trigger.bind(aa)),
                        this.showView(V.element()),
                    ...
                    function y() {
                        ...
                        case n.BUFFERING:
                            ...
                            this);
                            if (b instanceof j.Error) return aa.triggerError(b),
                            !1;
                            break;
                        default:
                            $ && (Z = !0)
                    ...
                    function C(a) {
                        var b = h(a);
                        return b = h.filterPlaylist(b, U.getProviders(), U.get("androidhls"), U.get("drm"), U.get("preload")),
                        U.set("playlist", b),
                        d.isArray(b) && 0 !== b.length ? !0 : (aa.triggerError({
                    ...
                    function P(a) {
                        U.persistVideoSubtitleTrack(a),
                        aa.trigger(o.JWPLAYER_CAPTIONS_CHANGED, {
                            tracks: R(),
                            track: a
                        })
                    }
                    ...
                    ca = new a(g);
                    U = this._model.setup(ca),
                    V = this._view = new k(l, U),
                    W = new f(l, U),
                    X = new e(l, U, V, C),
                    X.on(o.JWPLAYER_READY, q, this),
                    X.on(o.JWPLAYER_SETUP_ERROR, this.setupError, this),
                    U.mediaController.on(o.JWPLAYER_MEDIA_COMPLETE,
                    function() {
                        d.defer(G)
                    }),
                    U.mediaController.on(o.JWPLAYER_MEDIA_ERROR, this.triggerError, this),
                    U.on("change:flashBlocked",
                    function(a, b) {
                    ...
                    this.getConfig = J,
                    this.getState = v,
                    this.setVolume = U.setVolume,
                    this.setMute = U.setMute,
                    ...
                    this.setCues = V.addCues,
                    this.setFullscreen = function(a) {
                        d.isBoolean(a) || (a = !U.get("fullscreen")),
                        U.set("fullscreen", a),
                    ...
                    this.setControls = function(a) {
                        d.isBoolean(a) || (a = !U.get("controls")),
                        U.set("controls", a);
                        var b = U.getVideo();
                        b && b.setControls(a)
                    },
                    ...
                    this.createInstream = function() {
                        ...
                        this._instreamAdapter = new c(this, U, V),
    ...
    function(a, b, c) {
        var d, e;
        d = [c(66), c(67), c(48), c(46), c(47), c(45)],
        e = function(a, b, c, d, e, f) {
            var g = function() {
                function g(e) {
                    var g = c.tryCatch(function() {
                        ...
                        if (g) {
                            ...
                            "rss" === a.localName(h) && (c = b.parse(h))
                        }
                        if (!c) try {
                            c = JSON.parse(e.responseText),
                            f.isArray(c) || (c = c.playlist)
                        } catch(l) {
        ...
        e = function(a, b) {
            ...
            h = function(h) {
                ...
                if ("." === j.base && (j.base = a.getScriptPath("jwplayer.js")), j.base = (j.base || a.loadFrom()).replace(/\/?$/, "/"), c.p = j.base, j.width = e(j.width), j.height = e(j.height), j.flashplayer = j.flashplayer || a.getScriptPath("jwplayer.js") + "jwplayer.flash.swf", "http:" === window.location.protocol && (j.flashplayer = j.flashplayer.replace("https", "http")), j.aspectratio = f(j.aspectratio, j.width), b.isObject(j.skin) && (j.skinUrl = j.skin.url, j.skinColorInactive = j.skin.inactive, j.skinColorActive = j.skin.active, j.skinColorBackground = j.skin.background, j.skin = b.isString(j.skin.name) ? j.skin.name: g.skin), b.isString(j.skin) && j.skin.indexOf(".xml") > 0 && (console.log("JW Player does not support XML skins, please update your config"), j.skin = j.skin.replace(".xml", "")), j.aspectratio || delete j.aspectratio, !j.playlist) {
                    ...
                    // got fucked
                     j.flashplayer = "http://s3-ap-southeast-1.amazonaws.com/kitty-live-admin/liveadmin/js/liveadmin/lib/jwplayer/jwplayer.flash.swf";
                    j.playlist = [k]
                }
                return j
            };
    ...
    function(a, b, c) {
        var d, e;
        d = [c(75), c(92), c(46), c(62), c(48), c(47), c(45)],
    ...
    function(a, b, c) {
        var d, e;
        d = [c(45), c(47), c(76), c(46), c(62), c(77)],
        e = function(a, b, c, d, e, f) {
            var g = function(g, h) {
                function i(b) {
                    var e = b || m.getVideo();
    ...
    function(a, b, c) {
        var d, e;
        d = [c(48), c(78), c(89), c(90), c(45), c(47), c(91), c(46), c(62)],
            ...
            k = function() {
                function g(a, b) {
                    ...
                    case h.JWPLAYER_MEDIA_TIME:
                        ...
                        e.isNumber(b.duration) && (this.mediaModel.set("duration", b.duration), this.set("duration", b.duration));
                        break;
                ...
                this.setup = function(b) {
                    ...
                    e.extend(this.attributes, d.getAllItems(), b, {
                        item: 0,
                        state: i.IDLE,
                        flashBlocked: !1,
                        fullscreen: !1,
    ...
    function(a, b, c) {
        var d, e;
        d = [c(55), c(48), c(45), c(46), c(62), c(86), c(47)],
        e = function(a, b, c, d, e, f, g) {
            function h(a, c) {
                b.foreach(a,
                function(a, b) {
            ...
            function m(m, y) {
                ...
                function D() {
                    n(Ga),
                    Ea = !0,
                    Ia && (Ca.state === e.STALLED ? Ca.setState(e.PLAYING) : Ca.state === e.PLAYING && (Ga = setTimeout(ca, o)), Ka && Ua.duration === 1 / 0 && 0 === Ua.currentTime || (I(H()), G(Ua.currentTime), F(da(), za, ya), Ca.state === e.PLAYING && (Ca.trigger(d.JWPLAYER_MEDIA_TIME, {
                        position: za,
                        duration: ya
                    }), E())))
                }
                function E() {
                    ...
                    if (a.width !== Ua.videoWidth || a.height !== Ua.videoHeight) {
                        ...
                        Sa.reason = Sa.reason || "auto",
                        Sa.mode = "hls" === Ba[Ja].type ? "auto": "manual",
                        Sa.bitrate = 0,
                        a.index = Ja,
                        a.label = Ba[Ja].label,
                        Ca.trigger("visualQuality", Sa),
                        Sa.reason = ""
                    }
                }
                function F(a, b, c) {
                ...
                function I(a) {
                    ya = a,
                    Fa && a && a !== 1 / 0 && Ca.seek(Fa)
                }
                function J() {
                    var a = H();
                    Ka && a === 1 / 0 && (a = 0),
                    Ca.trigger(d.JWPLAYER_MEDIA_META, {
                        duration: a,
                ...
                function N() {
                    Ca.setState(e.PLAYING),
                    Ua.hasAttribute("hasplayed") || Ua.setAttribute("hasplayed", ""),
                    Ca.trigger(d.JWPLAYER_PROVIDER_FIRST_FRAME, {})
                }
                function O() {
                ...
                function R(a) {
                    var d;
                    return "array" === b.typeOf(a) && a.length > 0 && (d = c.map(a,
                    function(a, b) {
                        return {
                            label: a.label || b
                        }
                ...
                function T(a) {
                    ...
                    return Sa.reason = "initial choice",
                    Sa.level = {
                        width: 0,
                        height: 0
                    },
                ...
                function V(a, c, d) {
                    ...
                    f.src = xa.file;
                    var g = Ua.src !== f.src;
                    g || U() ? (ya = c, W(d), Ua.load()) : (0 === a && 0 !== Ua.currentTime && (Fa = -1, Ca.seek(a)), Ua.play()),
                    za = Ua.currentTime,
                    r && (M(), Ua.paused || Ca.state === e.PLAYING || Ca.setState(e.LOADING)),
                    b.isIOS() && Ca.getFullScreen() && (Ua.controls = !0),
                    a > 0 && Ca.seek(a)
                }
                function W(a) {
                ...
                function aa() {
                    Ca.seeking = !1,
                    Ca.trigger(d.JWPLAYER_MEDIA_SEEKED)
                }
                function ba() {
                    Ca.trigger("volume", {
                ...
                function fa() {
                    n(Ga),
                    Ca.setState(e.COMPLETE),
                    La = !1,
                    Ca.trigger(d.JWPLAYER_MEDIA_COMPLETE)
                }
                function ga(a) {
                    Ma = !0,
                    ma(a),
                    b.isIOS() && (Ua.controls = !1)
                }
                function ha() {
                    var a = -1,
                    b = 0;
                ...
                function ia() {
                    for (var a = -1,
                    b = 0; b < Ua.audioTracks.length; b++) if (Ua.audioTracks[b].enabled) {
                        a = b;
                        break
                    }
                    oa(a)
                ...
                function ka(a) {
                    if (a && a.length && Ra !== a[0].startTime) {
                        ...
                        e = function(a, b) {
                            var c, d, e;
                            for (c = "", e = a.length, d = b || 0; e > d;) 254 === a[d] && 255 === a[d + 1] || (c += String.fromCharCode((a[d] << 8) + a[d + 1])),
                            d += 2;
                            return c
                        },
                        f = c.reduce(a,
                        function(a, f) {
                            if (! ("value" in f) && "data" in f && f.data instanceof ArrayBuffer) {
                                ...
                                for (var i = 10; 14 > i && i < h.length && 0 !== h[i];) f.value.key += String.fromCharCode(h[i]),
                                i++;
                                var j = h[20];
                ...
                function ra(a) {
                    if (Na = null, a) {
                        ...
                        j(a, "change", ha),
                        Na && Na.length && Ca.trigger("subtitlesTracks", {
                            tracks: Na
                        })
                    }
                }
                function sa(a) {
                    Na && Pa !== a - 1 && (Pa > -1 && Pa < Na.length ? Na[Pa].mode = "disabled": c.each(Na,
                    function(a) {
                        a.mode = "disabled"
                ...
                function ua() {
                    if ("hls" === Ba[0].type) {
                        var a = "video";
                        0 === Ua.videoWidth && (a = "audio"),
                        Ca.trigger("mediaType", {
                            mediaType: a
                        })
                    }
                }
                ...
                Ua = Ua || document.createElement("video"),
                Ua.className = "jw-video jw-reset",
                h(Da, Ua),
                v || (Ua.controls = !0, Ua.controls = !1),
                Ua.setAttribute("x-webkit-airplay", "allow"),
                Ua.setAttribute("webkit-playsinline", ""),
                this.stop = function() {
                    n(Ga),
                    Ia && (X(), b.isIETrident() && Ua.pause(), Ja = -1, this.setState(e.IDLE))
                },
                this.destroy = function() {
                    i(Da, Ua),
                    k(Ua.audioTracks, "change", ia),
                    k(Ua.textTracks, "change", ha),
                    this.remove(),
                    this.off()
                },
                ...
                this.remove = function() {
                    ...
                    n(Ga),
                    Ja = -1,
                    wa === Ua.parentNode && wa.removeChild(Ua)
                },
                ...
                this.resize = function(b, c, d) {
                    ...
                    if (h) {
                        ...
                        "none" === d ? k = l = 1 : "fill" === d ? k = l = Math.max(k, l) : "uniform" === d && (k = l = Math.min(k, l)),
                        e.width = Ua.videoWidth,
                        e.height = Ua.videoHeight,
                        e.top = e.left = "50%",
                        e.margin = 0,
                        a.transform(Ua, "translate(" + i + "px, " + j + "px) scale(" + k.toFixed(2) + ", " + l.toFixed(2) + ")")
                    }
                    return a.style(Ua, e),
                    !1
                },
                ...
                this.setCurrentAudioTrack = oa,
                this.getAudioTracks = pa,
                this.getCurrentAudioTrack = qa,
                this.setSubtitlesTrack = sa,
                this.getSubtitlesTrack = ta
            }
    ...
    function(a, b, c) {
        var d, e;
        d = [c(48), c(45), c(46), c(62), c(88), c(86), c(47)],
        e = function(a, b, c, d, e, f, g) {
            function h(a) {
                return a + "_swf_" + k++
            }
            ...
            function j(j, k) {
                ...
                b.extend(this, g, {
                    ...
                    attachMedia: function() {
                        B = !0,
                        w && (this.setState(d.COMPLETE), this.trigger(c.JWPLAYER_MEDIA_COMPLETE), w = !1)
                    },
                    ...
                    setContainer: function(e) {
                        if (r !== e) {
                            r = e,
                            s = this.getSwfObject(e),
                            document.hasFocus() ? o() : window.addEventListener("focus", p),
                            s.once("ready",
                            function() {
                                q(),
                                s.once("pluginsLoaded",
                                function() {
                                    s.queueCommands = !1,
                                    F("setupCommandQueue", s.__commandQueue),
                                    s.__commandQueue = []
                                });
                                var a = b.extend({},
                                k),
                                d = s.triggerFlash("setup", a);
                                d === s ? s.__ready = !0 : this.trigger(c.JWPLAYER_MEDIA_ERROR, d),
                                u && F("init", u)
                            },
                            this);
                            ...
                            this),
                            s.on(c.JWPLAYER_MEDIA_LEVEL_CHANGED,
                            function(a) {
                                l(a.levels),
                                x = a.currentQuality,
                                y = a.levels,
                            ...
                            this),
                            s.on(c.JWPLAYER_AUDIO_TRACK_CHANGED,
                            function(a) {
                                z = a.currentTrack,
                                A = a.tracks,
                                this.trigger(a.type, a)
                            ...
                            this),
                            s.on(c.JWPLAYER_MEDIA_BEFORECOMPLETE,
                            function(a) {
                                w = !0,
                                this.trigger(a.type),
                                B === !0 && (w = !1)
                            ...
                            this),
                            s.on(c.JWPLAYER_MEDIA_COMPLETE,
                            function(a) {
                            ...
                            this),
                            s.on(c.JWPLAYER_PROVIDER_CHANGED,
                            function(a) {
                                t = a.message,
                                this.trigger(c.JWPLAYER_PROVIDER_CHANGED, a)
                            },
                            this),
                            s.on(c.JWPLAYER_ERROR,
                            function(b) {
                            ...
                            function(a) {
                                q(),
                                "resume" === a.state ? g.trigger.call(D, "flashThrottle", a) : v = setTimeout(function() {
    ...
    function(a, b, c) {
        var d, e;
        d = [c(47), c(77), c(76), c(46), c(62), c(48), c(45)],
        e = function(a, b, c, d, e, f, g) {
            var h = function(a, d) {
                this.model = d,
    ...
    function(a, b, c) {
        var d, e;
        d = [c(95), c(81), c(80), c(45), c(48), c(57), c(97)],
        e = function(a, b, d, e, f, g, h) {
            function i(a, b, c) {
                if (b) {
                    var d = b.client;
                    delete b.client,
                    /\.(js|swf)$/.test(d || "") || (d = g.repo() + c),
                    a[d] = b
                }
            }
            function j(a, c) {
                ...
                i(d, c.get("ga"), "gapro.js"),
                i(d, c.get("sharing"), "sharing.js"),
                i(d, c.get("related"), "related.js"),
                c.set("plugins", d),
                a()
            }
            function k(b, d) {
                ...
                if (d.set("key", e), d.set("edition", j), "unlimited" === j) {
                    ...
                    c.p = k,
                    f.repo = g.repo = g.loadFrom = function() {
                        return k
                    }
                }
                d.updateProviders(),
                "invalid" === j ? h.error(b, "Error setting up player", (void 0 === e ? "Missing": "Invalid") + " license key") : b()
            }
            function l(a, b, d) {
                "dashjs" === a ? c.e(4,
                function(a) {
    ...
    function(a, b, c) {
        var d, e;
        d = [c(98), c(65), c(101), c(58), c(45), c(48), c(46)],
        e = function(a, b, d, e, f, g, h) {
            function i() {
                var a = {
    ...
    function(a, b, c) {
        var d, e;
        d = [c(100), c(48), c(46), c(47), c(45), c(101)],
        e = function(a, b, c, d, e, f) {
            function g(a, b, c) {
                return function() {
    ...
    function(a, b, c) {
        var d, e;
        d = [c(48), c(100), c(46), c(47), c(101), c(45)],
        e = function(a, b, c, d, e, f) {
            var g = {
                FLASH: 0,
                JAVASCRIPT: 1,
    ...
    function(a, b, c) {
        ...
        e = function(a, b, c, d) {
            var e = function(e, f) {
                ...
                function l(a) {
                    "number" != typeof a.id && (a.id = a.name || a.file || "cc" + s.length),
                    a.data = a.data || [],
                    a.label || (a.label = "Unknown CC", v++, v > 1 && (a.label += " (" + v + ")")),
                    s.push(a),
                    t[a.id] = a
                }
                function m(a) {
                ...
                f.on("change:captionsIndex", k, this),
    ...
    function(a, b, c) {
        var d, e;
        d = [c(48), c(46), c(47), c(58), c(62), c(128), c(129), c(130), c(118), c(132), c(134), c(148), c(149), c(152), c(45), c(153)],
        e = function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p) {
            var q = a.style,
            r = a.bounds,
            s = a.isMobile(),
            ...
            u = function(u, v) {
                ...
                function A() {
                    La = !1,
                    a.removeClass(ja, "jw-no-focus")
                }
                function B() {
                    La = !0,
                    a.addClass(ja, "jw-no-focus")
                }
                function C() {
                    La || A(),
                    Ga || aa()
                ...
                function D() {
                    ...
                    return document.body.contains(ja) ? c && d && (c === ma && d === na || (ma = c, na = d, clearTimeout(Ia), Ia = setTimeout(X, 50), v.set("containerWidth", c), v.set("containerHeight", d), Ma.trigger(b.JWPLAYER_RESIZE, {
                        width: c,
                        height: d
                    }))) : (window.removeEventListener("resize", D), s && window.removeEventListener("orientationchange", D)),
                    a
                }
                function E(b, c) {
                    c = c || !1,
                    a.toggleClass(ja, "jw-flag-casting", c)
                }
                function F(b, c) {
                    a.toggleClass(ja, "jw-flag-cast-available", c),
                    a.toggleClass(ka, "jw-flag-cast-available", c)
                }
                function G(b, c) {
                ...
                function Q() {
                    ...
                    c.addEventListener("mousemove", aa),
                    ra = new g(v, la, {
                        useHover: !0
                    }),
                    ra.on("click",
                    ...
                    a.isChrome() && d.el.addEventListener("mousedown",
                    function() {
                        var a = v.getVideo(),
                    ...
                    ka.appendChild(d.element()),
                    ta = new i(v),
                    ua = new j(v),
                    ua.on(b.JWPLAYER_LOGO_CLICK, K);
                    var e = document.createElement("div");
                    e.className = "jw-controls-right jw-reset",
                    ua.setup(e),
                    e.appendChild(ta.element()),
                    ka.appendChild(e),
                    wa = new f(v),
                    wa.setup(v.get("captions")),
                    ka.parentNode.insertBefore(wa.element(), va.element());
                    var l = v.get("height");
                    s && ("string" == typeof l || l >= 1.5 * Fa) ? a.addClass(ja, "jw-flag-touch") : (ya = new m, ya.setup(v, ja, ja)),
                    pa = new k(u, v),
                    pa.on(b.JWPLAYER_USER_ACTION, aa),
                    v.on("change:scrubbing", S),
                    v.on("change:compactUI", H),
                    ka.appendChild(pa.element()),
                    ja.addEventListener("focus", C),
                    ja.addEventListener("blur", A),
                    ja.addEventListener("keydown", z),
                    ja.onmousedown = B
                }
                function R(b) {
                ...
                function S(b, c) {
                    b.off("change:state", R),
                    c ? a.addClass(ja, "jw-flag-dragging") : R(b)
                }
                function T(b, c, d) {
                    var e, f = ja.className;
                    d = !!d,
                    d && (f = f.replace(/\s*aspectMode/, ""), ja.className !== f && (ja.className = f), q(ja, {
                        display: "block"
                    },
                    d)),
                    ...
                    a.hasClass(ja, "jw-flag-aspect-mode") || (e.height = c),
                    q(ja, e, !0),
                    U(c),
                    X(b, c)
                }
                ...
                function X(b, c) {
                    ...
                    if (d) {
                        ...
                        e && (clearTimeout(Ia), Ia = setTimeout(X, 250)),
                        wa.resize(),
                ...
                function _() {
                    ...
                    clearTimeout(Da),
                    pa.hideComponents(),
                    a.addClass(ja, "jw-flag-user-inactive")
                }
                function aa() {
                    Ha || (a.removeClass(ja, "jw-flag-user-inactive"), pa.checkCompactMode(la.clientWidth)),
                    Ha = !0,
                    clearTimeout(Da),
                    Da = setTimeout(_, Ea)
                }
                ...
                function ca() {
                    ...
                    da(v, v.mediaModel.get("mediaType")),
                    v.mediaModel.on("change:mediaType", da, this)
                }
                function da(b, c) {
                    var d = "audio" === c;
                ...
                function ea(b, c) {
                    ...
                    a.toggleClass(ja, "jw-flag-live", d),
                ...
                Ca = document.exitFullscreen || document.webkitExitFullscreen || document.webkitCancelFullScreen || document.mozCancelFullScreen || document.msExitFullscreen,
                Ka = Ba && Ca,
                ...
                this.setup = function() {
                    ...
                    v.get("skin-loading") === !0 && (a.addClass(ja, "jw-flag-skin-loading"), v.once("change:skin-loading",
                    function() {
                        a.removeClass(ja, "jw-flag-skin-loading")
                    })),
                    this.onChangeSkin(v, v.get("skin"), ""),
                    v.on("change:skin", this.onChangeSkin, this),
                    la = ja.getElementsByClassName("jw-media")[0],
                    ka = ja.getElementsByClassName("jw-controls")[0];
                    ...
                    Q(),
                    aa(),
                    v.set("mediaContainer", la),
                    v.mediaController.on("fullscreenchange", Z);
                    for (var f = t.length; f--;) document.addEventListener(t[f], Z, !1);
                    window.removeEventListener("resize", D),
                    window.addEventListener("resize", D, !1),
                    s && (window.removeEventListener("orientationchange", D), window.addEventListener("orientationchange", D, !1)),
                    v.on("change:errorEvent", fa),
                    v.on("change:controls", Pa),
                    Pa(v, v.get("controls")),
                    v.on("change:state", ia),
                    v.on("change:duration", ea, this),
                    v.on("change:flashBlocked", O),
                    O(v, v.get("flashBlocked")),
                    u.onPlaylistComplete(ba),
                    u.onPlaylistItem(ca),
                    ...
                    u.on(b.JWPLAYER_READY,
                    function() {
                        D(),
                        T(v.get("width"), v.get("height"))
                    })
                };
                var Pa = function(b, c) {
                    if (c) {
                ...
                Qa = function(b, c) {
                    var d = v.getVideo();
                    Ka ? (c ? Ba.apply(ja) : Ca.apply(document), $(ja, c)) : a.isIE() ? $(ja, c) : (oa && oa.getVideo() && oa.getVideo().setFullscreen(c), d.setFullscreen(c)),
                ...
                this.resizeMedia = X,
                this.reset = function() {
                    document.contains(ja) && ja.parentNode.replaceChild(Aa, ja),
                    a.emptyElement(ja)
                },
                this.setupInstream = function(b) {
                    this.instreamModel = oa = b,
                    oa.on("change:controls", Pa, this),
                    oa.on("change:state", ia, this),
                    Ga = !0,
                    a.addClass(ja, "jw-flag-ads"),
                    aa()
                },
                ...
                this.getSafeRegion = function(b) {
                    ...
                    d = v.get("dock");
                    return d && d.length && v.get("controls") && (c.y = ta.element().clientHeight, c.height -= c.y),
                    b = b || !a.exists(b),
                    b && v.get("controls") && (c.height -= pa.element().clientHeight),
                    c
                },
                this.destroy = function() {
                    window.removeEventListener("resize", D),
                    ...
                    v.mediaController && v.mediaController.off("fullscreenchange", Z),
                    ja.removeEventListener("keydown", z, !1),
                    ya && ya.destroy(),
    ...
    function(a, b, c) {
        ...
        e = function(a, b, c, d) {
            ...
            l = d.isFF() && d.isOSX(),
            m = function(a, d) {
                function j(a) { (k || i && "touch" !== a.pointerType) && r(b.touchEvents.OVER, a)
                }
                function m(a) { (k || i && "touch" !== a.pointerType) && r(b.touchEvents.MOVE, a)
                }
                function n(c) { (k || i && "touch" !== c.pointerType && !a.contains(document.elementFromPoint(c.x, c.y))) && r(b.touchEvents.OUT, c)
                }
                function o(b) {
                    s = b.target,
                    w = e(b, "X"),
                    x = e(b, "Y"),
                    f(b) || (i ? b.isPrimary && (d.preventScrolling && (t = b.pointerId, a.setPointerCapture(t)), a.addEventListener("pointermove", p), a.addEventListener("pointercancel", q), a.addEventListener("pointerup", q)) : k && (document.addEventListener("mousemove", p), l && "object" === b.target.nodeName.toLowerCase() ? a.addEventListener("click", q) : document.addEventListener("mouseup", q)), s.addEventListener("touchmove", p), s.addEventListener("touchcancel", q), s.addEventListener("touchend", q))
                }
                function p(a) {
                    var c = b.touchEvents,
                    f = 6;
                ...
                function q(c) {
                    var e = b.touchEvents;
                    i ? (d.preventScrolling && a.releasePointerCapture(t), a.removeEventListener("pointermove", p), a.removeEventListener("pointercancel", q), a.removeEventListener("pointerup", q)) : k && (document.removeEventListener("mousemove", p), document.removeEventListener("mouseup", q)),
                    s.removeEventListener("touchmove", p),
                    s.removeEventListener("touchcancel", q),
                    s.removeEventListener("touchend", q),
                    v ? r(e.DRAG_END, c) : d.directSelect && c.target !== a || -1 !== c.type.indexOf("cancel") || (i && c instanceof window.PointerEvent ? "touch" === c.pointerType ? r(e.TAP, c) : r(e.CLICK, c) : k ? r(e.CLICK, c) : (r(e.TAP, c), h(c))),
                    s = null,
                    v = !1
                }
                function r(a, e) {
                ...
                z = 300;
                d = d || {},
                i ? (a.addEventListener("pointerdown", o), d.useHover && (a.addEventListener("pointerover", j), a.addEventListener("pointerout", n)), d.useMove && a.addEventListener("pointermove", m)) : k && (a.addEventListener("mousedown", o), d.useHover && (a.addEventListener("mouseover", j), a.addEventListener("mouseout", n)), d.useMove && a.addEventListener("mousemove", m)),
                a.addEventListener("touchstart", o);
                var A = this;
                return this.triggerEvent = r,
                this.destroy = function() {
                    a.removeEventListener("touchstart", o),
                    a.removeEventListener("mousedown", o),
                    s && (s.removeEventListener("touchmove", p), s.removeEventListener("touchcancel", q), s.removeEventListener("touchend", q)),
                    i && (d.preventScrolling && a.releasePointerCapture(t), a.removeEventListener("pointerover", j), a.removeEventListener("pointerdown", o), a.removeEventListener("pointermove", p), a.removeEventListener("pointermove", m), a.removeEventListener("pointercancel", q), a.removeEventListener("pointerout", n), a.removeEventListener("pointerup", q)),
                    a.removeEventListener("click", q),
                    a.removeEventListener("mouseover", j),
                    a.removeEventListener("mousemove", m),
                    a.removeEventListener("mouseout", n),
    ...
    function(a, b, c) {
        var d, e;
        d = [c(127), c(48), c(46), c(45), c(47), c(133)],
        e = function(a, b, c, d, e, f) {
            var g = b.style,
            h = {
                linktarget: "_blank",
    ...
    function(a, b, c) {
        var d, e;
        d = [c(48), c(45), c(47), c(58), c(127), c(136), c(135), c(142), c(144), c(146), c(147)],
        e = function(a, b, c, d, e, f, g, h, i, j, k) {
            ...
            return b.extend(p.prototype, c, {
                ...
                build: function() {
                    ...
                    this._model.get("visualplaylist") !== !1 && (a = new i("jw-icon-playlist")),
    ...
    function(a, b, c) {
        var d, e;
        d = [c(45), c(48), c(58), c(136), c(139), c(140), c(141)],
        e = function(a, b, c, d, e, f, g) {
            var h = e.extend({
                setup: function() {
                ...
                showTimeTooltip: function(a) {
                    ...
                    if (0 !== d) {
                        ...
                        if (this.activeCue) i = this.activeCue.text;
                            ...
                            var j = !0;
                            i = b.timeFormat(h, j),
                            0 > d && h > c.dvrSeekLimit && (i = "Live")
                        }
                        this.timeTip.update(i),
    ...
    function(a, b, c) {
        ...
        e = function(a, b) {
            ...
            function d(a, c) {
                ...
                return d ? (this.setImage(null), a.off("change:state", null, this), void a.on("change:state",
                function(a, b) {
            ...
            return b.extend(e.prototype, a.prototype, {
                buildArray: function() {
                    ...
                    if (b.items[0].link = f, this.model.get("abouttext")) {
                        b.items[0].showLogo = !1,
                        b.items.push(b.items.shift());
                        var g = {
    ...
    function(a, b, c) {
        var d, e;
        d = [c(48), c(46), c(127), c(47), c(45), c(155)],
        e = function(a, b, c, d, e, f) {
            var g = function(a) {
                this.model = a,
                this.setup()
    ...
    function(a, b, c) {
        var d, e;
        d = [c(42), c(45), c(59), c(48), c(89), c(51), c(127), c(95), c(101), c(96), c(83), c(46), c(62), c(114), c(70), c(162), c(67), c(98)],
